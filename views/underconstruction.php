...
<html lang="en">
	<head>
		...
		<meta name="author" content="See what they are saying" />

		<link rel="icon" type="image/x-icon" href="favicon.ico">

		<title>See what they are saying</title>
			...
			<section class="py-5 text-center container">
				<div class="row py-lg-3">
					<div class="col-lg-6 col-md-8 mx-auto">
						<div class="d-flex align-items-center">
							<h1 class="navTitle fw-bolder mb-0 px-0 px-md-2">Under construction...</h1>
							<p class="blinking fw-normal mb-0 px-2 px-md-0 h-100">&#9608;</p>
						</div>
					</div>
				</div>
