...
CREATE TABLE `tweets` (
  ...
  `last_reply` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `summary_pros` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `summary_cons` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `summary_undetermined` longtext CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci,
  `total_pros` smallint unsigned DEFAULT NULL,
  `total_cons` smallint unsigned DEFAULT NULL,
  `total_undetermined` smallint unsigned DEFAULT NULL,
...
-- Dump completed on 2023-04-01 11:14:25
